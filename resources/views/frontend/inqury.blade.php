            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" required class="input-field rounded-lg py-2" placeholder="Enter your phone number">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Dealer Name -->
                    <div>
                        <label class="block text-white font-medium">Dealer Name</label>
                        <input type="text" name="dealer" required class="input-field rounded-lg py-2" placeholder="Enter dealer name">
                    </div>

                    <!-- Distributor Name -->
                    <div>
                        <label class="block text-white font-medium">Distributor Name</label>
                        <input type="text" name="distributor" required class="input-field rounded-lg py-2" placeholder="Enter distributor name">
                    </div>
                </div>

                <!-- Subject -->
                <div>
                    <label class="block text-white font-medium">Subject</label>
                    <input type="text" name="subject" required class="input-field rounded-lg py-2" placeholder="Enter your subject">
                </div>

                <!-- Message -->
                <div>
                    <label class="block text-white font-medium">Message</label>
                    <textarea name="message" required class="input-field h-28 resize-none rounded-lg" placeholder="Type your message here"></textarea>
                </div>
